"""Tests for creating a process model from a template."""
import re
...
def _open_create_modal(page: Page) -> None:
    ...
    if not create_button.is_visible(timeout=5_000):
...
def test_create_process_model_modal_opens(authenticated_page: Page) -> None:
...
def test_create_process_model_validation(authenticated_page: Page) -> None:
...
def test_create_process_model_full_flow(authenticated_page: Page) -> None:
...
def test_create_process_model_auto_fills_from_template(authenticated_page: Page) -> None:
